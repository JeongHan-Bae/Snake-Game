...
class Snaky {
public:
    [[maybe_unused]] constexpr static const std::pair<int, int> EAST= {1, 0};
    [[maybe_unused]] constexpr static const std::pair<int, int> WEST = {-1, 0};
    [[maybe_unused]] constexpr static const std::pair<int, int> NORTH = {0, -1};
    [[maybe_unused]] constexpr static const std::pair<int, int> SOUTH = {0, 1};
...
public:
    ...
    [[maybe_unused]] void getSnakePositions(int*& positionsArray, int& arrayLength) const {
